          ...
          <div class="row" id="order-body">
            ...
            <div class="col-sm-6">
                <table  class="table table-bordered">
                    ...
                    <tr><td>Number of packages:</td><td><a href="#" class="updateInfoRequired" data-name="number_package" data-type="text" data-pk="{{ $order->id }}" data-url="{{ route("admin_order.update") }}" data-title="Number of packages" >{!! $order->number_package !!}</a></td></tr>
