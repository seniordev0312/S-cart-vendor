...
@endif
                        ...
                        <div class="form-group row">
                            <label for="upc" class="col-sm-2 col-form-label">{{ sc_language_render('product.upc') }}</label>
                                <div class="col-sm-8">
                                    <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text"><i class="fas fa-pencil-alt"></i></span>
                                    </div>
                                    <input type="text" class="form-control" name="upc" value="{{ old('upc', $product->upc) }}" placeholder="{{ sc_language_render('product.upc') }}" />
                                </div>
                            </div>
                        </div>
                        {{-- upc --}}
